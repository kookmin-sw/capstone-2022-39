...
def approach_detail_link_and_extract_recruitment_info(driver, detail_link_list, announcement_list_Jeonbuk_Jeonbuk):
    ...
    return detail_page_text, announcement_list_Jeonbuk_Jeonbuk
...
def main(driver):
    ...
    while index < len(next_link) - 2:
        ...
        detail_page_text, announcement_list_Jeonbuk_Jeonbuk = approach_detail_link_and_extract_recruitment_info(driver, detail_link_list, announcement_list_Jeonbuk_Jeonbuk)
