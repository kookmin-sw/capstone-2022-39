...
def detail_collect_Announcement(url, sheet, data_list, announcement_list_Worknet):
...
def main():
    ...
    announcement_list_Worknet = detail_collect_Announcement(url, sheet, data_list, announcement_list_Worknet)
