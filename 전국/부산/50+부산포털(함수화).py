...
def approach_detail_link_and_extract_recruitment_info(driver, detail_link_list, sheet):
    for detail_link_connect in detail_link_list:
        ...
        # 모집 분야
        recruitment_field = driver.find_element(By.XPATH,
                                                '//*[@id="job_container"]/div[6]/table/tbody/tr[4]/td[1]').text
...
def main():
    ...
    while index < len(detail_link):
        ...
        approach_detail_link_and_extract_recruitment_info(driver, detail_link_list, sheet)
